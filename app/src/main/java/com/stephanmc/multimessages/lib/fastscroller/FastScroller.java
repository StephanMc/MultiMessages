...
public class FastScroller extends LinearLayout {
    ...
    private boolean mStyleApplied = false;
    ...
    public FastScroller(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray style = context.obtainStyledAttributes(attrs, com.futuremind.recyclerviewfastscroll.R.styleable.fastscroll__fastScroller, com.futuremind.recyclerviewfastscroll.R.attr.fastscroll__style, 0);
        try {
            bubbleColor = style.getColor(com.futuremind.recyclerviewfastscroll.R.styleable.fastscroll__fastScroller_fastscroll__bubbleColor, STYLE_NONE);
            handleColor = style.getColor(com.futuremind.recyclerviewfastscroll.R.styleable.fastscroll__fastScroller_fastscroll__handleColor, STYLE_NONE);
            bubbleTextAppearance = style.getResourceId(com.futuremind.recyclerviewfastscroll.R.styleable.fastscroll__fastScroller_fastscroll__bubbleTextAppearance, STYLE_NONE);
        } finally {
            style.recycle();
        }
        maxVisibility = getVisibility();
        setViewProvider(new com.stephanmc.multimessages.lib.fastscroller.DefaultScrollerViewProvider());
    }

    /**
     * Enables custom layout for {@link com.futuremind.recyclerviewfastscroll.FastScroller}.
     * @param viewProvider A {@link ScrollerViewProvider} for the {@link com.futuremind.recyclerviewfastscroll.FastScroller} to use when building layout.
     */
    ...
    /**
     * Attach the {@link com.futuremind.recyclerviewfastscroll.FastScroller} to {@link RecyclerView}. Should be used after the adapter is set
     * to the {@link RecyclerView}. If the adapter implements SectionTitleProvider, the FastScroller
     * will show a bubble with title.
     * @param recyclerView A {@link RecyclerView} to attach the {@link com.futuremind.recyclerviewfastscroll.FastScroller} to.
     */
    ...
    /**
     * Set the orientation of the {@link com.futuremind.recyclerviewfastscroll.FastScroller}. The orientation of the {@link com.futuremind.recyclerviewfastscroll.FastScroller}
     * should generally match the orientation of connected  {@link RecyclerView} for good UX but it's not enforced.
     * Note: This method is overridden from {@link LinearLayout#setOrientation(int)} but for {@link com.futuremind.recyclerviewfastscroll.FastScroller}
     * it has a totally different meaning.
     * @param orientation of the {@link com.futuremind.recyclerviewfastscroll.FastScroller}. {@link #VERTICAL} or {@link #HORIZONTAL}
     */
    @Override
